 ...
 * starting from root. Boundary includes left boundary, leaves, and right boundary in order without duplicate nodes.
 * 
 * Left boundary is defined as the path from root to the left-most node.
 * Right boundary is defined as the path from root to the right-most node.
 * 
 * if the the root doesn't have left subtree or right subtree, then the root itself is left
 ...
 * travel to the left subtree if exists.
 * 
 ...
 * The right boundary are nodes 1,3,6,10. (10 is the right-most node).
